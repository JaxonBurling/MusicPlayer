...
import { wx_appid, wx_secret, cryptoMd5, cryptoSha1, randomString, wx_lite_appid, wx_lite_secret, isLite } from '../util';
 ...
 * @returns
 */
const ticket = (accessToken: any) => axios({ url: 'https://api.weixin.qq.com/cgi-bin/ticket/getticket', params: { access_token: accessToken, type: 2 } });

export default (_params: KugouParams, _useAxios: UseAxios) => {
